                            ...
                            <div className={styles.footerLogo}>
                                <div className={styles.logoWrapper}>
                                    <div className={styles.logoText}>
                                        <span className={styles.logoTextMain}>Tech</span>
                                        <span className={styles.logoTextAccent}>News</span>
                                    </div>
                                </div>
                            </div>
                            <p className={styles.footerDesc}>
                                Your trusted source for the latest technology news, business insights,
                                and in-depth analysis. Stay informed with TechNews.
                            </p>
